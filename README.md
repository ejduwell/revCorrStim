...
- Do a few annoying tweaks required before running for first time on a new machine. (I'll fix these.. I promise) ( [jump to section](https://github.com/ejduwell/revCorrStim/tree/main?tab=readme-ov-file#machine-specific-tweaks-that-need-to-be-done-before-running-stimulus-for-first-time) )
