...
- However, it does this in a powerfully generalized manner:
    ...
    - The full set of all possible parameters combinations is generated by feeding this list of vectors into "combvec"
    - The set of all possible parameter combos is reduced to only those which meet the logical constraints via logical indexing.
    - This set of parameter combos is used to generate the corresponding base images.
- Effectively: it allows users to pregenerate a set of base images which tile an entire n-dimensional parameter space in a highly flexible manner.
