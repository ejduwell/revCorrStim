function [trialtm,ts_out,qs_out,sd_out,nr_ideals, params_out, tdf_out] = RevCorrQuest5_int_v6_practice(room,kboard,numtrials,link,noise,window,image_dir,db_mode,db_mode_screen,nr_params, imtag, pthrds, n_int, qst_startParams,t_prob,maxmin,maxmin_seg,main_dir,olCon,parTagz,obj1Par,obj2Par,qstParStr,noise_dir,nWt,nTag,sessionDir)
