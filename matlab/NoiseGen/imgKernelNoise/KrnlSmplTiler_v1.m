...
[adjImg, kSampleArrayz, kernelDim_ImFrac, kernelSqrDims, kernelPosCnts] = kernelSubSampler(imgInPath,selectSize,desiredSize);
...
%==========================================================================
kNumber=7; % specify the kernel used to tile...
rng("shuffle");
