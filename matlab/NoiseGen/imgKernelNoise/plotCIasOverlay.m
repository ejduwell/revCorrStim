function plotCIasOverlay(biIn,ciIn,ciWt,ciThr, figDims, clrMap,alphVal,idealCI,biStr,ciStr,IdlCIStr,configStr,noiseConfigStr)
...
%(for ideal ci too)
[upperMaskIdl, lowerMaskIdl, upperMskCIIdl,lowerMskCIIdl] = CI_Thrshld_Percent(double(idealCI),ciThr);
