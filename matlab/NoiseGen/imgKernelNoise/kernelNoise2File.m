...
nWorkers=10; % number of cpu nodes used in the parallelized portions..
...
%[nzImz] = kernelNoise_v1_2(imgsPerKrnl,desiredSize,krnlNzBI,nReps,krnlImgWgts,smoothTiles,gSmthK1sz,smoothFinal,gSmthK2sz);
...
for ii=1:nImzTemp
    imNameStr=strcat("noiseSample",num2str(ii,'%05.f'),".png");
