...
jobChunks=1; % sets the number of chunks you want to break the job 
              % (total reps) into..
...
gSmthK1sz=[1,1,1,1,1,1,1,1,1]; % size of gaussian smoothing kernel for subtiles..
...
%krnlNzBI="/home/eduwell/SynologyDrive/SNAP/projects/imgKernelNoise/pyAlignFaceOutTest6/dir2/094_08.jpg";

%krnlNzBI_dir="/home/eduwell/SynologyDrive/SNAP/projects/imgKernelNoise/pyAlignFaceOutTest6/dir2";
%biTag=".jpg";

%Tex
%krnlNzBI_dir="/home/eduwell/SynologyDrive/SNAP/projects/revCorrStim/images/test6_TexOnly-19-Apr-2024-11-43-14/nocc";
%Lum
krnlNzBI_dir="/home/eduwell/SynologyDrive/SNAP/projects/revCorrStim/images/test4_LumOnly-05-Mar-2024-10-12-48/nocc";
biTag=".png";

%krnlNzBI="/MATLAB Drive/revCorrNoizGen-Grid/baseImg/gabLeft.png";
%krnlNzBI="/MATLAB Drive/revCorrNoizGen-Grid/baseImg/cateq512.jpg";
%krnlNzBI="/MATLAB Drive/revCorrNoizGen-Grid/baseImg/faceImg.jpg";
...
%outDirMain="/MATLAB Drive/imgKernelNoise/outputDir";
...
[biFiles, numFilesProcessed] = getAllFileNamesRec(krnlNzBI_dir,biTag);
krnlNzBIz=uint8(zeros(desiredSize(1),desiredSize(2),numFilesProcessed));% preallocate

for nn=1:numFilesProcessed
krnlNzBI=imread(biFiles(nn));
krnlNzBI = imgReformater(krnlNzBI,desiredSize);
krnlNzBIz(:,:,nn)=krnlNzBI;
end
...
[nzImz] = kernelNoise_v1_4(imgsPerKrnl,desiredSize,krnlNzBIz,nReps,krnlImgWgts,smoothTiles,gSmthK1sz,smoothFinal,gSmthK2sz);
