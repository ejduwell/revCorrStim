function filtered_image = butterworthbpf_v2(I,d0,d1,n,pltFig)
...
% EJD's Update to make just a function/not convert to uint8 or plot
...
% rescale back to range of input values
filtered_image=rescale(filtered_image,origRng(1),origRng(2));