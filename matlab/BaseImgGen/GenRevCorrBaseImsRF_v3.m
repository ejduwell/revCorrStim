function GenRevCorrBaseImsRF_v3
...
thisFile = "GenRevCorrBaseImsRF_v3.m"; % string should correspond to the name of this file's name..
...
%% Parameters
    ...
    indcrPenW=8; % sets pen width for the "inducer" lines
    fxnSqrSclr=32; % this par controls the scaling of the central fixation square.. Note: its proportion of the "main dimension" of the stimulus.. ie mainDim/fxnSqrSclr.. Bigger fxnSqrSclr-->smaller square
    fxnParz=[indcrPenW,fxnSqrSclr];
    
    %% Common Region Parameters
    %--------------------------------------------------------------
    CR = 1; %Include Common Region Box?
    CR_penWidth = 8; % If so, specify pen width for common region box..
    ...
    %lum1 = linspace(0,127.5,51);  
    %lum2 = linspace(127.5,255,51); % num between 0-255 150
...
imOutMat = RevCorrBaseImGen_v2(parsIn,window,change_screensize,scale_f,imOutMat,method,baseOutDir,norm,fxnParz);
