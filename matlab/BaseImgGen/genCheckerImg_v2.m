...
meanLum=127.5; % mean luminance of output checkerboard..

chckrAmplitude=0.01; % checker amplitude (number from 0 to 1.. 1 means amplitde of checker contrast spans 100% the possible range of black to white, 0.5 is 50%, 0 is 0% )
...
meanAdjust=meanLum-chkrMLarray_wAve_mean;
