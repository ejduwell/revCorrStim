...
% RevCorrBaseImGen_v1 is a function for generating base
try
%% Parameters
...
out_name = strcat(basename,"_occ_",num2str(occluders),"_ori_",orient,"_","CR",num2str(CR),"CRpw",num2str(CR_penWidth),"CRpl",num2str(CR_penLum),"CRal",num2str(CR_al),"CRob",num2str(CR_obj),"CRdm",num2str(cr_long),num2str(cr_short),"_T",num2str(T),imName,"Tr1",scalefactor1_str,"Tr2",scalefactor2_str,"T_al",num2str(T_al),"_L",num2str(L),"l1",num2str(lum1),"l2",num2str(lum2),"LWT",num2str(lumWt),"L_al",lumWt_str,"_Ocon",num2str(objcon),".",out_fmt);

if crop == 1
    img_snap = imgSizeEdit(img_snap,cropsz,"nearest");
end
