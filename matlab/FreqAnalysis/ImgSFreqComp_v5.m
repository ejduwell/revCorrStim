function meanRMSE = ImgSFreqComp_v5(varargin)
...
addAttachedFiles(gcp,["getGlobalOptPars.m","getGlobalIterCount.m", "getGlobalBaseImPspec.m"])
...
meanRMSE = mean(rmse_mat(1,1:end));
...
disp(strcat("Mean Square Error Between im1 and im2 Spatial Frequency Power Spectra:"," ",num2str(meanRMSE)))
